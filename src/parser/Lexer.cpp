...
Token Lexer::identifier() {
    ...
    static std::unordered_map<std::string, TokenType> keywords = {
        {"differentiable", TokenType::KEYWORD}, {"if", TokenType::KEYWORD},
        {"else", TokenType::KEYWORD}, {"while", TokenType::KEYWORD},
        {"for", TokenType::KEYWORD}, {"return", TokenType::KEYWORD},
        {"int", TokenType::KEYWORD}, {"float", TokenType::KEYWORD},
        {"double", TokenType::KEYWORD}, {"void", TokenType::KEYWORD}
    };
...
Token Lexer::stringLiteral() {
    ...
    return {TokenType::STRING_LITERAL, source.substr(start, position - start - 1)};
}
